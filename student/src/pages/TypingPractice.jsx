...
const TypingPractice = () => {
    ...
    return (
        <div className={`min-h-[calc(100vh-80px)] w-full flex flex-col items-center bg-gray-50 text-gray-800 p-3 md:p-6 font-sans transition-colors duration-300`}>
            ...
            {/* Top Bar */}
            <div className="w-full max-w-5xl flex flex-col md:flex-row items-stretch md:items-center justify-between bg-white p-4 rounded-xl shadow-sm mb-4 md:mb-8 gap-4">
                ...
                <div className="flex items-center justify-end gap-2 md:gap-3">
                    ...
                    <button onClick={resetTest} className="flex items-center gap-2 px-3 py-2 md:px-4 bg-indigo-600 hover:bg-indigo-700 text-white rounded-lg font-medium transition-colors shadow-sm shadow-indigo-200 text-sm md:text-base">
                        <RotateCcw size={16} />
                        <span>Reset</span>
                    </button>
                </div>
            ...
            {showHistory ? (
                <div className="w-full max-w-5xl bg-white p-4 md:p-6 rounded-2xl shadow-sm border border-gray-100 fade-in">
                ...
                <>
                    {/* Stats */}
                    <div className="w-full max-w-5xl grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-4 mb-4 md:mb-8">
                    ...
                    {/* Typing Area */}
                    <div className="relative w-full max-w-5xl bg-white rounded-2xl shadow-sm border border-gray-100 p-4 md:p-8 min-h-[250px] md:min-h-[300px] flex flex-col justify-center cursor-text" onClick={() => inputRef.current?.focus()}>
                        ...
                        <div
                            ...
                            className="font-mono text-lg md:text-2xl leading-relaxed text-gray-400 select-none break-words whitespace-pre-wrap max-h-[400px] overflow-hidden relative"
                    ...
                    {mode === 'time' && (
                        <div className="w-full max-w-5xl mt-8 h-1.5 bg-gray-200 rounded-full overflow-hidden mb-8">
                            <motion.div
                    ...
                    >
                        ...
                        >
                            <div className="bg-gradient-to-r from-indigo-600 to-purple-600 p-6 md:p-8 text-white text-center">
                                ...
                                <p className="text-indigo-100 mt-2 text-sm md:text-base">You completed the {typingLessons[category]?.[lessonIndex]?.title} lesson.</p>
                            </div>
                            ...
                            <div className="p-6 md:p-8">
                                ...
                                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                                    <button onClick={resetTest} className="flex items-center justify-center gap-2 px-8 py-3 md:py-4 bg-gray-100 hover:bg-gray-200 text-gray-700 rounded-xl font-bold transition-all text-base md:text-lg">
                                        <RotateCcw size={20} />
                                        Retry
                                    </button>
                                    <button onClick={() => { setLessonIndex((prev) => (prev + 1) % typingLessons[category].length); resetTest(); }} className="flex items-center justify-center gap-2 px-8 py-3 md:py-4 bg-indigo-600 hover:bg-indigo-700 text-white rounded-xl font-bold shadow-lg shadow-indigo-200 transition-all text-base md:text-lg transform hover:-translate-y-1">
                                        <Play size={20} />
                                        Next Lesson
                                    </button>
                                </div>
