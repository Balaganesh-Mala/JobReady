...
const WhatsAppButton = () => {
    ...
    if (!rawNumber) return null; // Don't show if no number configured
        ...
        >
            <div className="relative">
                ...
                <motion.div 
                    ...
                    whileTap={{ scale: 0.9 }}
                    className="relative flex items-center justify-center w-14 h-14 bg-[#25D366] rounded-full shadow-lg shadow-green-200 text-white"
                >
                    {/* Tooltip on Hover */}
